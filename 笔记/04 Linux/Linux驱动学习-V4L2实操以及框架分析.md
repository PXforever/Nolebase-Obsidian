...
![7yuv查看](笔记/01 附件/Linux驱动学习-V4L2实操以及框架分析/image-20240806165946886.png)

![qv4l2查看](笔记/01 附件/Linux驱动学习-V4L2实操以及框架分析/image-20240806165727121.png)

# V4L2的数据填充(`v4l2_virtualOut`)
我们先寻找一张简单的`gif`图，在网络上搜索：`gif图拆分在线`，将其拆分为多张图片，然后使用`Img2Lcd`工具转换出对应的图像数组：
![image-20240807111509911](笔记/01 附件/Linux驱动学习-V4L2实操以及框架分析/image-20240807111509911.png)
...
![image-20240807111944692](笔记/01 附件/Linux驱动学习-V4L2实操以及框架分析/image-20240807111944692.png)
